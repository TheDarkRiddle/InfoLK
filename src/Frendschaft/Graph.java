 ...
 * </p>
 * <p>
 * Klasse Frendschaft.Graph
 * </p>
 * <p>
 * Die Klasse Frendschaft.Graph stellt einen ungerichteten, kantengewichteten Graphen dar. Es koennen
 ...
 * Knotenobjekt zu einer bestimmten ID gehoert und ob der Frendschaft.Graph leer ist.
 * </p>
 * 
...
public class Graph{
  ...
  /**
   * Ein Objekt vom Typ Frendschaft.Graph wird erstellt. Der von diesem Objekt
   * repraesentierte Frendschaft.Graph ist leer.
   */
  public Graph(){
  ...
  /**
   * Die Anfrage liefert eine neue Liste aller Knotenobjekte vom Typ List<Frendschaft.Vertex>.
   */
  public List<Vertex> getVertices(){
    //Eine neue Liste mit allen Frendschaft.Vertex-Objekten erstellen.
  ...
  /**
   * Die Anfrage liefert eine neue Liste aller Kantenobjekte vom Typ List<Frendschaft.Edge>.
   */
  public List<Edge> getEdges(){
    //Eine neue Liste mit allen Frendschaft.Edge-Objekten erstellen.
  ...
  public Vertex getVertex(String pID){
    //Frendschaft.Vertex-Objekt mit pID als ID suchen.
    Vertex result = null;
    vertices.toFirst();
  ...
  public void addVertex(Vertex pVertex){
    //Pruefen, ob der Frendschaft.Vertex existiert und eine ID hat.
    if (pVertex != null && pVertex.getID() != null) {
      //Pruefen, ob nicht schon ein Frendschaft.Vertex mit gleicher ID enthalten ist.
      boolean freeID = true;
      vertices.toFirst();
      ...
      //Wenn die ID noch frei ist, den Frendschaft.Vertex einfuegen, sonst nichts tun.
      if (freeID) {
  ...
  /**
   * Die Anfrage liefert alle Nachbarn des Knotens pVertex als neue Liste vom Typ List<Frendschaft.Vertex>. Hat der Knoten
   ...
   * als Objekt vom Typ Frendschaft.Edge. Ist der Knoten pVertex oder der Knoten pAnotherVertex nicht
  ...
  /**
   * Die Anfrage liefert true, wenn der Frendschaft.Graph keine Knoten enthaelt, ansonsten false.
   */
